      ...
      <div className="card h-100" style={{ cursor: 'pointer' }}>
        ...
        <div style={{ position: 'relative', overflow: 'hidden', borderRadius: 'var(--card-radius) var(--card-radius) 0 0' }}>
          ...
          <div style={{ 
            ...
            {space.time_slots && space.time_slots.length > 0 && (
              ...
              >
                {space.time_slots.length} booking options
              </span>
            )}
          </div>
        </div>
        ...
        <div className="card-body d-flex flex-column">
          ...
          <div className="mt-auto">
            <div className="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2" style={{ fontWeight: '600' }}>
